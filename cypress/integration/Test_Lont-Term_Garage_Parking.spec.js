...
describe("Testing  the Long-Term Garage Parking cost should be $2.00 per hour", () => {
  it("Open Application", () => {
    cy.openMainPage();
  });
...
describe("Testing  the Long-Term Garage Parking cost should be $12.00 daily maximum", () => {
  it("Open Application", () => {
    cy.openMainPage();
  });
...
describe("Testing  the Long-Term Garage Parking cost should be $72.00 per week (7th day free)", () => {
  it("Open Application", () => {
    cy.openMainPage();
  });
